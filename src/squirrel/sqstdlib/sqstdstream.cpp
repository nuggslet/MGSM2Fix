...
template <Squirk Q>
static SQRegFunction<Q> _stream_methods[] = {
...
template <Squirk Q>
void init_streamclass(HSQUIRRELVM<Q> v)
{
	...
	if(SQ_FAILED(sq_get(v,-2))) {
		...
		SQInteger i = 0;
		while(_stream_methods<Q>[i].name != 0) {
			SQRegFunction<Q> &f = _stream_methods<Q>[i];
