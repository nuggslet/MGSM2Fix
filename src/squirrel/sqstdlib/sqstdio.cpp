...
template <Squirk Q>
static SQInteger _file__typeof(HSQUIRRELVM<Q> v)
{
...
template <Squirk Q>
static SQInteger _file_constructor(HSQUIRRELVM<Q> v)
{
...
template <Squirk Q>
static SQRegFunction<Q> _file_methods[] = {
...
template <Squirk Q>
SQRESULT sqstd_createfile(HSQUIRRELVM<Q> v, SQFILE file,SQBool own)
{
...
template <Squirk Q>
SQRESULT sqstd_getfile(HSQUIRRELVM<Q> v, SQInteger idx, SQFILE *file)
{
	SQFile *fileobj = NULL;
...
template <Squirk Q>
SQRESULT sqstd_loadfile(HSQUIRRELVM<Q> v,const SQChar *filename,SQBool printerror)
{
...
template <Squirk Q>
SQRESULT sqstd_dofile(HSQUIRRELVM<Q> v,const SQChar *filename,SQBool retval,SQBool printerror)
{
...
template <Squirk Q>
SQInteger _g_io_loadfile(HSQUIRRELVM<Q> v)
{
...
template <Squirk Q>
SQInteger _g_io_writeclosuretofile(HSQUIRRELVM<Q> v)
{
	const SQChar *filename;
	sq_getstring(v,2,&filename);
...
template <Squirk Q>
SQInteger _g_io_dofile(HSQUIRRELVM<Q> v)
{
	const SQChar *filename;
	SQBool printerror = SQFalse;
	sq_getstring(v,2,&filename);
...
template <Squirk Q>
SQRESULT sqstd_register_iolib(HSQUIRRELVM<Q> v)
{
	SQInteger top = sq_gettop(v);
	//create delegate
	declare_stream(v,_SC("file"),(SQUserPointer)SQSTD_FILE_TYPE_TAG,_SC("std_file"),_file_methods<Q>,iolib_funcs<Q>);
