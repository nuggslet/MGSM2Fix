...
template <Squirk Q>
static SQInteger math_iabs(HSQUIRRELVM<Q> v)
{
	SQInteger n;
	sq_getinteger(v,2,&n);
...
template <Squirk Q>
static SQInteger math_min(HSQUIRRELVM<Q> v)
{
...
template <Squirk Q>
static SQInteger math_max(HSQUIRRELVM<Q> v)
{
	SQInteger n = sq_gettop(v);
	SQInteger maxidx = 2;
	for(SQInteger i = 3; i <= n; i++) {
